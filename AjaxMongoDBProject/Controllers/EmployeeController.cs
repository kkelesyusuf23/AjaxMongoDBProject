...
namespace AjaxMongoDBProject.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        {
            var valeus = await _employeeCollection.Find(x => x.EmployeeID == EmployeeID).FirstOrDefaultAsync();
        ...
        {
            var valeus = await _employeeCollection.FindOneAndReplaceAsync(x => x.EmployeeID == employee.EmployeeID, employee);
            return NoContent();
        }
    }
}
